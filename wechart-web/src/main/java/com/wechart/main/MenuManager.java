...
import com.wechart.common.MenuOperate;
import com.wechart.menu.*;
...
public class MenuManager {
    ...
    public static void main(String[] args) {
        // 第三方用户唯一凭证
        String appId = "wxe91f349429853766";
        // 第三方用户唯一凭证密钥
        String appSecret = "85022851115b01566e22e874fd619093";
        ...
        if (null != token) {
            // 创建菜单
            boolean result = MenuOperate.createMenu(getMenu(), token.getAccessToken());
